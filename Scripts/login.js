...
document
  ...
  .addEventListener("submit", (e) => {
    ...
    if (
      ...
      fd.append("register_last_name", lastName);
      fd.append("register_gender", gender);
...
document
  .getElementById("resetPasswordFormElement")
  .addEventListener("submit", (e) => {
    e.preventDefault();
...
document
  .getElementById("securityQuestionFormElement")
  .addEventListener("submit", (e) => {
    e.preventDefault();
